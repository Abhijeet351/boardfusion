...
window.BFCloud=(function(){
 ...
 load();return{signIn,signUp,signOut,leaderboard,rename,recordWin,get user(){return user},get token(){return token}};
})();
